...
Uma experiência digital criada para apresentar os produtos da empresa de forma **moderna, elegante e visualmente impactante**, valorizando imagens, vídeos, animações e uma navegação simples e intuitiva. O site também foi estruturado para facilitar a geração de contatos e pedidos de orçamento.
...
- [Destaques técnicos](#destaques-t%C3%A9cnicos)
...
A página inicial utiliza um vídeo em tela cheia como elemento principal de apresentação, reforçando a identidade visual da marca desde o primeiro contato.
...
Para visualizar o projeto, execute um servidor HTTP local na raiz do repositório. Embora seja possível abrir o arquivo diretamente no navegador, o uso de um servidor local oferece maior compatibilidade com vídeos, fontes e recursos externos.
...
Este projeto foi desenvolvido para uma empresa-cliente. Seus conteúdos visuais, identidade de marca, imagens, vídeos e demais materiais podem estar sujeitos a direitos autorais.

O código deste repositório é disponibilizado para fins de **portfólio e demonstração técnica**, salvo indicação diferente ou acordo específico com o cliente.

---

## Outros projetos

Mais projetos e experimentos estão disponíveis em:

[**https://github.com/JS171555?tab=repositories**](https://github.com/JS171555?tab=repositories)
